...
public class Captain extends Unit {
	...
	public static final Image IMAGE = SpriteSheet.UNITS.getSprite(SIZE, 1, 1);
	...
	public static final int AVAILABLE = 4, RANK = 6;
	
	public Captain(int team, Board board, int x, int y) throws FieldNotPassableExteption {
