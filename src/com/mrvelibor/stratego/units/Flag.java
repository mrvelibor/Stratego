...
public class Flag extends Unit {
	...
	public static final Image IMAGE = SpriteSheet.UNITS.getSprite(SIZE, 0, 0);
	...
	public static final int AVAILABLE = 1, RANK = 0;
	
	public Flag(int team, Board board, int x, int y) throws FieldNotPassableExteption {
