...
public class Liutenant extends Unit {
	
	public static final Image IMAGE = SpriteSheet.UNITS.getSprite(SIZE, 2, 1);
	...
	public static final int AVAILABLE = 4, RANK = 5;
	
	public Liutenant(int team, Board board, int x, int y) throws FieldNotPassableExteption {
