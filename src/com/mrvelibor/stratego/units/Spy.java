...
public class Spy extends Unit {
	...
	public static final Image IMAGE = SpriteSheet.UNITS.getSprite(SIZE, 2, 2);
	...
	public static final int AVAILABLE = 1, RANK = 1;
	
	public Spy(int team, Board board, int x, int y) throws FieldNotPassableExteption {
	...
	public int calculateAttack(Unit target) {
		if(target instanceof Marshal) return 1;
