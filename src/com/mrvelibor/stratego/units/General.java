...
public class General extends Unit {
	...
	public static final Image IMAGE = SpriteSheet.UNITS.getSprite(SIZE, 2, 0);
	...
	public static final int AVAILABLE = 1, RANK = 9;
	
	public General(int team, Board board, int x, int y) throws FieldNotPassableExteption {
