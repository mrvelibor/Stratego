...
public class Colonel extends Unit {
	...
	public static final Image IMAGE = SpriteSheet.UNITS.getSprite(SIZE, 3, 0);
	...
	public static final int AVAILABLE = 2, RANK = 8;
	
	public Colonel(int team, Board board, int x, int y) throws FieldNotPassableExteption {
